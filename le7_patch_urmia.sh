...
export LC_NUMERIC
cd ${INDIR}
#le07_p${PTH}_dates_NW.csv
for t in `cat le7_p168.csv`; do
	rm -f names.txt
	...
	r.composite red=${SEN}_L1TP_p${PTH}_patch_${t}_T1_B4 green=${SEN}_L1TP_p${PTH}_patch_${t}_T1_B3 blue=${SEN}_L1TP_p${PTH}_patch_${t}_T1_B2 output=${SEN}_L1TP_p${PTH}_patch_${t}_T1_comp
